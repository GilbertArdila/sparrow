    ...
    return (
        <div className='w-full max-w-[250px]   sticky z-50 top-2  px-3'>
            <div className='flex items-center p-3 rounded-full relative  '>
                ...
                <input type="text" className='absolute inset-0 rounded-full pl-11 border-gray-500 text-gray-700 bg-blue-100 focus:bg-white focus:shadow-lg focus:ring-0 ' placeholder='search tweet' />
            </div>
        </div>
    )
}
