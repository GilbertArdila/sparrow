...
const Menu = () => {
    return (
        <menu className='mt-4 mb-2.5 xl:items-start'>
            <ul className='flex flex-col space-y-3  '>
               
                    <li className=' hoverEffect li'>
                    ...
                    <span className='font-bold hidden xl:block'>Home</span>
                </li>
                ...
                <li className='hoverEffect li'>
                    ...
                    <span className='font-bold hidden xl:inline'>List</span>
                ...
                <li className='hoverEffect li'>
                    ...
                    <span className='font-bold hidden xl:inline'>More</span>
